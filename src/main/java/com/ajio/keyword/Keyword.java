...
public class Keyword extends Constant {
	...
	public static void openBrowser() {
		String browserName = CustomUtil.getParameter("browser");
		switch (browserName) {
		case "chrome":
	...
	public static void launchURL() {
		String url = CustomUtil.getParameter("baseUrl");
		driver.get(url);
	...
	public static void pageLoadTimeOut() {
		long duration = Long.parseLong(CustomUtil.getParameter("PLtimeOut"));
		String timeUnit = CustomUtil.getParameter("PLtimeUnit");
		switch (timeUnit) {
		case "NANOSECONDS":
	...
	public static void implicitWait() {
		long duration = Long.parseLong(CustomUtil.getParameter("IWtimeOut"));
		String timeUnit = CustomUtil.getParameter("IWtimeUnit");
		switch (timeUnit) {
		case "NANOSECONDS":
	...
	public static void expllicitWait() {
		long duration = Long.parseLong(CustomUtil.getParameter("EWtimeOut"));
		String timeUnit = CustomUtil.getParameter("EWtimeUnit");
		switch (timeUnit) {
		case "NANOSECONDS":
	...
	public static boolean workingLinks(List<WebElement> links, String baseUrl) {
		huc=null;
		link="";
		responseCode=0;
		boolean linkWorking = true;
